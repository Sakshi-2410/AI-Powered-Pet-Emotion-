...
export const PawPrintIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M11.33 7.5c-1.33 2-3.33 4-5.33 4-2 0-3-2-3-4 0-2.2 1.8-4 4-4 1.5 0 2.8.8 3.5 2" />
    <path d="M12.67 7.5c1.33 2 3.33 4 5.33 4 2 0 3-2 3-4 0-2.2-1.8-4-4-4-1.5 0-2.8.8-3.5 2" />
  </svg>
);
